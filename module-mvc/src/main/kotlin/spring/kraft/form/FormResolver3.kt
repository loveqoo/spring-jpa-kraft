...
abstract class FormResolver3<ID, E, in CF, in UF, P1_ID, P1, P2_ID, P2, P3_ID, P3> :
    ...
    override fun CF.createEntity(): Result<E> =
        this
            .parent1()
            .zipLazy({ this.parent2() }, { this.parent3() }) { p1, p2, p3 ->
                this.toEntity(p1, p2, p3)
            }.flatMap { it }
    ...
    override fun UF.resolveEntity(): Result<E> =
        ...
        ) { entity, parent1, parent2, parent3 ->
            this.update(entity, parent1, parent2, parent3).map { entity }
        }.flatMap { it }
}
